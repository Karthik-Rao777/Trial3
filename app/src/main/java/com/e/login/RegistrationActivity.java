                ...
                if (verificationCode.equals(""))
                {
             ...
             else
                 {
                    ...
                    if(!phoneNumber.equals(""))
                    {
                        ...
                        Toast.makeText(RegistrationActivity.this,"Please write valid phone number", Toast.LENGTH_SHORT);
                    }
                 }
            }
        });
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>()
                {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                        ...
                        {
                           loadingBar.dismiss();
                           Toast.makeText(RegistrationActivity.this,"Congrats,,You are logged in succesfully", Toast.LENGTH_SHORT).show();
